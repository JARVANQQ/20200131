        ...
        <section class="section">
          ...
          <div class="activity">
            <div class="activity-item" v-for="(support, index) in info.supports" :key="index"
                 :class="activityColor[support.type]">
    ...
    methods: {
      _initScroll () {
        this.$nextTick(() => {
          ...
          const ulWidth = this.$refs.picList
          const liWidth = 120
          const space = 6
          const pictures = this.info.pics.length
          ulWidth.style.width = (liWidth * pictures) + (pictures-1) * 6 + 'px'
