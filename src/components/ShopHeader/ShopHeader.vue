<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowContent=!isShowContent">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-meslsage-detail">
            {{info.description}}
    ...
    <div class="shop-header-discounts" @click="isShowBrief=!isShowBrief" v-if="info.supports">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowContent">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="isShowContent=!isShowContent"></span>
          </div>
        </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="isShowBrief">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item" :class="activityColor[support.type]" v-for="(support, index) in info.supports" :key="index">
            <span class="content-tag">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-close" @click="isShowBrief=!isShowBrief"></span>
          </div>
        </div>
