<template>
  <div class="shop_container">
          ...
          <div class="shop_right">
            ...
            <section class="shop_rating_order">
              <section class="shop_rating_order_left">
                <Star :size="size" :score="shop.rating"></Star>
    ...
    <img src="./images/shop_back.svg" alt="back" v-else v-for="(item, index) in 6" :key="index">
  </div>
</template>
...
<script>
  ...
  export default {
    data () {
      return{
        //http://cangdu.org:8001/img//2/35/696aa5cf9820adada9b11a3d14bf5jpeg.jpeg
